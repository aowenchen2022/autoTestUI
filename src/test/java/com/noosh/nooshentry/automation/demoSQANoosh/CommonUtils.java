...
public class CommonUtils extends Page {	
	 ...
	 private String passwd = "17password"; 
	 ...
	 public void loginUser1(String userName) throws InterruptedException {
	     ...
	     if(!submitbutton.isDisplayed()) {
	         ...
	         long endingTime = currentTime();
	         long loginTime = loadingTime(startingTime, endingTime);
	         System.out.println("***Home Page login loading time: " + loginTime + " seconds ***");
	     }
	     Thread.sleep(5000);
	 }
	 ...
	 public void spLogout() throws InterruptedException {	 
		 WebElement topMenu = driver.findElement(By.id("topMenuBook"));
		 topMenu.click();
		 Thread.sleep(1000);
		 Actions builder = new Actions(driver);
		 builder.moveToElement(topMenu).perform();
		 Thread.sleep(5000);
		 driver.findElement(By.id("topMenuLogout")).click();
		 Thread.sleep(3500);
	 }
	 ...
	 public void testGmailLoginPreCon() throws InterruptedException {
		 ...
		 // add 10/25 
		  ...
		  try {
			  accountChooserLink = driver.findElement(By.id("profileIdentifier"));
		  } catch (Exception e) {
			  // do nothing
		  }
		  ...
		  WebElement anotehrAccountLink = null;
		  try {
			  anotehrAccountLink = driver.findElement(By.className("BHzsHc"));
		  } catch (Exception e) {
			  // do nothing
		  }
		  if (anotehrAccountLink != null) {
			  anotehrAccountLink.click();
			  Thread.sleep(500);
		  }	 
     }
	 ...
	 public void testSPcreateProject(String projNameSP, String descriptionNameSP, String sku, String referenceNumber, String quantSP, String specDescrSP,
                 String fileForProject1) throws InterruptedException, AWTException {
		 BrochurePopupWindow brochurePopup = new BrochurePopupWindow(driver);
		 Thread.sleep(2000);   	    
		 brochurePopup.callCalendar();
	 ...
	 public void verifyUploadedImg(String fileName) {
		 ...
		 String imgName = createProjectTabFiles.findElement(By.className("dz-filename")).findElement(By.tagName("pre")).getAttribute("title");
